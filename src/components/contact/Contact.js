...
const Contact = () => {
  ...
  const EMAILJS_CONFIG = {
    SERVICE_ID: "service_etjdk16", // Replace with your actual service ID
    TEMPLATE_ID: "template_ou7zxwi", // Replace with your actual template ID
    PUBLIC_KEY: "SO1g3Uo5lacXOtKIk" // Replace with your actual public key
  };
    ...
    if (username === "") {
      ...
      emailjs.send(
        ...
        EMAILJS_CONFIG.TEMPLATE_ID,
        {
          ...
          subject: subject,
          message: message,
          to_email: 'ibrahimsanusib10@gmail.com'
        }
      )
      .then((result) => {
